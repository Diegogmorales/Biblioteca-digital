...
// ---------------------------------------------------------------------------
// Post-processing: a soft bloom lets the warm point light "breathe" instead
// of being a hard-edged blob, plus an OutputPass to restore correct
// tone-mapping/color-space handling once the composer is in charge of output.
// ---------------------------------------------------------------------------
...
const bloomPass = new UnrealBloomPass(
  ...
  0.42,   // strength — subtle, just a glow, not a glare
  0.55,   // radius
